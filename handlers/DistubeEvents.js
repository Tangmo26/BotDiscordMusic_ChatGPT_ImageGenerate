          ...
          case "autoplay":
            {
              if (!channel) {
                return send(
                  interaction,
                  `** ${client.config.emoji.ERROR} เธอต้องเข้าร่วม Voice Channel ก่อนนะคะ**`
                );
              } else if (
                ...
                return send(
                  interaction,
                  ` ${client.config.emoji.ERROR} เธอต้องเข้าร่วม __My__ Voice Channel ก่อนนะคะ `
                );
              } else if (!queue) {
                return send(
                  interaction,
                  ` ${client.config.emoji.ERROR} อาเนียไม่ได้เล่นเพลงตอนนี้ `
                );
              } else if (checkDJ) {
                return send(
                  interaction,
                  `${client.config.emoji.SUCCESS} เธอต้องเป็น Dj ก่อนนะคะถึงจะขอเพลงได้..`
                );
      ...
      if (message.channelId === musicchannel.id) {
        ...
        if (message.author.bot) {
          ...
          if (
            ...
            return client.embed(
              message,
              `** ${client.config.emoji.ERROR} อาเนียไม่ได้รับอนุญาติให้เข้า Voice Channel นี้ 🥲 **`
            );
