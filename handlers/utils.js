    ...
    let embed = new EmbedBuilder()
      ...
      .setImage(
        guild.banner
          ...
          : `https://media.tenor.com/2vkg2P2nWVkAAAAC/lonely-anya-spy-x-family.gif`
      )
      .setFooter({
        text: guild.name,
    ...
    queueembed.edit({
      embeds: [
        new EmbedBuilder()
          .setColor(client.config.embed.color)
          .setAuthor({
            name: `Anya Queue  -  [ ${queue.songs.length} Tracks ]`,
            iconURL: guild.iconURL({ dynamic: true }),
          })
