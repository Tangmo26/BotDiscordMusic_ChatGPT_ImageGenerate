module.exports = {
  ...
  embed: {
    color: process.env.color || "#F59D99",
    wrongcolor: process.env.wrongcolor || "#8a0808",
    footertext: "Coded by Anya Forger",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
  ...
  links: {
    inviteURL: process.env.inviteURL || `https://discord.com/api/oauth2/authorize?client_id=1094954016036880414&permissions=8&scope=bot`,
    DiscordServer: process.env.DiscordServer || `https://spy-family.net/`,
    VoteURL: process.env.VoteURL || `https://discord.gg/FuKfAREn9f`,
    Website: `https://www.instagram.com/spyfamily_en/`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true,
